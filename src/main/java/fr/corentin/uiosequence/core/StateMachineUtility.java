 ...
 * - Building state machines from JSON files
 * - Analyzing state machine outputs
 * - Printing results and details
...
public class StateMachineUtility {
     ...
     */
    public static Map<Integer, Map<String, Transition>> buildStateMachineFromJson(InputStream inputStream)
            throws IOException {
